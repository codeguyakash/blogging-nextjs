  ...
  return (
    <div className="w-[80%] m-auto">
      ...
      <p>
        ...
        <br />
        <br />
        <h2>4. DNS Propagation:</h2> DNS propagation occurs when changes are
        ...
        <br />
        <br />
        <h2>5. Importance of DNS:</h2> User-Friendly Internet: DNS makes the
        ...
        <br />
        <br />
        <h2>Conclusion:</h2> In essence, DNS is the unsung hero that makes
